...
const Footer: React.FC = () => {
    ...
    const contactData: IContactInfo[] = [
        {
            icon: <TbWorld className='bg-[red] text-[40px] m-[10px] p-[5px] rounded-[50px]' />,
            link: 'https://kajhfiamvasod.gov.co/',
            text: 'https://kajhfiamvasod.gov.co/'
        },
        {
            icon: <PiPhoneLight className='bg-[red] text-[40px] m-[10px] p-[5px] rounded-[50px]' />,
            link: 'tel:+576067417700',
            text: '+57 606 7417700'
        },
        {
            icon: <HiOutlineMailOpen className='bg-[red] text-[40px] m-[10px] p-[5px] rounded-[50px]' />,
    ...
    return (
        <footer className='bg-[#0b3d91] text-[white] p-[20px] text-center'>
            ...
            <div className='mt-[20px]'>
                ...
                <p className='m-0 text-[12px] text-[#cacaca]'>© Todos los derechos reservados 2024</p>
            </div>
        </footer>
    );
};
